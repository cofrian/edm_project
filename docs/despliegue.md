...
5. Variables opcionales de movilidad: `VALENCIA_VALENBISI_TTL_SECONDS`, `VALENCIA_EMT_ARRIVALS_TTL_SECONDS`, `VALENCIA_EMT_ARRIVALS_TIMEOUT_SECONDS`, `VALENCIA_EMT_ROUTES_URL`, `VALENCIA_EMT_GTFS_RESOURCE_ID`, `VALENCIA_EMT_GTFS_URL`, `VALENCIA_EMT_GTFS_NAP_FILE_ID`, `VALENCIA_EMT_GTFS_API_KEY`.
...
- Movilidad backend: `VALENCIA_VALENBISI_TTL_SECONDS=180`, `VALENCIA_EMT_STOPS_TTL_SECONDS=21600`, `VALENCIA_EMT_ARRIVALS_TTL_SECONDS=45`, `VALENCIA_EMT_ARRIVALS_TIMEOUT_SECONDS=12`, `VALENCIA_EMT_ROUTES_TTL_SECONDS=21600`, `VALENCIA_EVENT_VALENBISI_RADIUS_METERS=1000`, `VALENCIA_EMT_DELAY_THRESHOLD_MINUTES=3`, `VALENCIA_EMT_AVG_SPEED_KMH=14`, `VALENCIA_EMT_ROUTES_URL` (GeoJSON opcional), `VALENCIA_EMT_GTFS_RESOURCE_ID`, `VALENCIA_EMT_GTFS_URL` (ZIP GTFS opcional), `VALENCIA_EMT_GTFS_NAP_FILE_ID`, `VALENCIA_EMT_GTFS_API_KEY` (solo para NAP).
